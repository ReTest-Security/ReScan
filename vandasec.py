...
def logo():
    if sys.platform.startswith("linux"):
        ...
        os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title VANDASEC DDoS")
    print('''
             - Twitter : @VANDASEC -

    /\_____/\     My Discord for support : NOT DEALING WITH THIS
   /  o   o  \    Support email : FUCKYOUSELF@FACEBOOK.COM
  ( ==  ^  == )   Twitter : @VANDASEC
   )         (    YouTube : VANDASEC
  (           )   ========================================================
 ( (  )   (  ) )     VandaSec DDoS - Bypass CloudFlare,OVH, EVERYTHING
